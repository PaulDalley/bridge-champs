import database, { firebase, membersRef, usersRef, googleAuthProvider, facebookAuthProvider } from '../../firebase/config';
...
export const userLoggedInSubscriptionExpires = (subscriptionExpires,
                                                paymentMethod,
                                                subscriptionActive,
                                                trialUsed=false,
) => ({
