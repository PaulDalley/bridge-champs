...
export const SET_USER_COMPLETED_PRACTICE = "SET_USER_COMPLETED_PRACTICE";
...
export const USER_SET_PROFILE_NAME = "USER_SET_PROFILE_NAME";
export const USER_SET_BEGINNER_MODE = "USER_SET_BEGINNER_MODE";
