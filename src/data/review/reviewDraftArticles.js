...
- Final takeaway.`,
  },
  {
    ...
    metaDescription:
      "Learn the three main defensive signals in bridge — attitude, count, and suit preference — and when each one applies in beginner-friendly terms.",
    teaser: "Signals turn defence from guesswork into a partnership conversation.",
    body: `Planned outline (Paul to expand):
- Why signals exist: defence is a two-player game and you can't talk. Cards are the only language.
- The three main signal types:
  - Attitude: "I like / I don't like this suit" (typically when partner leads).
  - Count: "I have an odd / even number of cards in this suit" (typically when declarer plays a suit).
  - Suit preference: "Switch to suit X / suit Y" (in specific situations).
- The simple default: high card encourages, low card discourages (standard attitude signals).
- Count signals: high-low = even, low-high = odd (standard count).
- Suit preference: a high spot card asks for the higher-ranking side suit, a low spot card asks for the lower.
- When each signal applies: a simple rule of thumb so you don't have to think too hard.
- Common signal mistakes: signaling when partner can't see, misreading a forced card as a signal, giving the wrong kind of signal at the wrong moment.
- Final takeaway: start with attitude, add count, then suit preference last.`,
  },
  {
    id: "BCF-06",
