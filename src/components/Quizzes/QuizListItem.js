...
import { makeDateString, makeBoardObjectFromString, getDifficultyStr } from '../../helpers/helpers';
...
const QuizListItem = ({
    ...
    return (
        ...
        <CardPanel key={id}
                   ...
                   className={`ArticlesListItem-container ${completed ? "" : "grey lighten-4"} black-text ${completedStyles}`}
         >
            ...
            {completed &&
                <div className="ArticleListItem-category DisplayQuiz-completed">Completed</div>
            }
            ...
            { a && <Button
                ...
                waves='light' icon='mode_edit'
                style={{ position: 'absolute', right: '2.5rem', bottom: '3rem', zIndex: 5 }}
            /> }
        </div>
    );
};
