...
const url = "https://us-central1-bridgechampions.cloudfunctions.net/stripeSubscribeTokenHandler";
// import {InjectedCheckoutForm, StripeProvider, Elements, CardForm, CardElement, injectStripe} from 'react-stripe-elements';

// const stripeKey = "pk_test_0oEg1KoEe7MkbdIe0LyU7oUD"; // TEST
const stripeKey = "pk_live_rbfFBjVRCEG6ciCZ1m8u9YSk"; // LIVE
...
class StripeCheckout extends React.Component {
    ...
    handleToken = response => {
        ...
        $.post(url, postData, (resData, status) => {
            // console.log(resData);
            // console.log(status);
    ...
    render() {
        return (
            <div>
                {this.state.stripe && <PaymentButton
