...
import {Modal, Collapsible, CollapsibleItem, ProgressBar, Col } from 'react-materialize';
import $ from 'jquery';
...
class DailyFreeSingleton extends React.Component {
    ...
    render() {
        ...
        if (this.state.loaded) {
            const { body: quizBodyId, answer, answers, question, ...quizMetadata} = quiz;
            ...
            quizDisplayJSX = (
                <Modal
                    ...
                    trigger={<btn id="free_quiz_modal_trigger"
                                  style={{opacity: 0, zIndex: -1}}>
                        btn
                    </btn>}
                >
                    <DisplayQuiz quizMetadata={quizMetadata}
            ...
            articleDisplayJSX = (
                <Modal
                    className="modal-fixed-footer DailyFreeSingleton-Modal"
                    style={{width: '95vw', minWidth: '95vw',}}
                    trigger={<btn id="free_article_modal_trigger"
                                  style={{opacity: 0, zIndex: -1}}>
                        btn
                    </btn>}
                >
                    <DisplayArticle articleMetadata={articleMetadata}
        ...
        if (!this.state.loaded) {
            return (
                <div className="DisplayArticle-container" style={{minHeight: "100vh"}}>
                    <Col s={12}>
                        <br/>
                        <br/>
                        <br/>
        ...
        if (shizzle) {
            return (
                <div className="DailyFreeSingleton-container">
                    <div className="DailyFreeSingleton-icons-external-div">
                        <i className="DailyFreeSingleton-item-icon far fa-newspaper"
                    ...
                    <div className="DailyFreeSingleton-icons-external-div DailyFreeSingleton-icons-external-div-second">
                        <i className="DailyFreeSingleton-item-icon DailyFreeSingleton-item-icon-quiz far fa-question-circle"
                           id="DailyFreeSingleton-icon-quiz"
                        ></i>
                    </div>
                    <Collapsible defaultActiveKey={false}>
                        <CollapsibleItem header={`Daily free article`}
                                         style={{zIndex: '1000'}}
                                         className="DailyFreeSingleton-item"
                        >
                            {articleJSX}
                        </CollapsibleItem>
                        <CollapsibleItem header='Daily free quiz'
                                         style={{zIndex: '1000'}}
                                         className="DailyFreeSingleton-item"
            ...
            return (
                ...
                >
                    <div className="DailyFreeSingleton-containerTwo">
                        <div className="DailyFreeSingleton-singleItem">
                            ...
                            <div className="DailyFreeSingleton-item_header">
                                <i className="DailyFreeSingleton-item-iconTwo far fa-newspaper"
                                   id="DailyFreeSingleton-icon-article"
                                ></i>Free Daily Article
                            </div>
                            <div className="DailyFreeSingleton-item_body">
                            {articleJSX}
                            </div>
                        </div>
                        <div className="DailyFreeSingleton-singleItem DailyFreeSingleton-quizItem">
                            ...
                            <div className="DailyFreeSingleton-item_header">
                                <i className="DailyFreeSingleton-item-iconTwo DailyFreeSingleton-item-icon-quiz far fa-question-circle"
                                   id="DailyFreeSingleton-icon-quiz"></i>Free Daily Quiz
                            </div>
                            <div className="DailyFreeSingleton-item_body">
                            {quizJSX}
                            </div>
                    ...
                    <div className="HomePage-SeparationLine DailyFreeSingleton-SeparationLine">
                    </div>
                    {quizDisplayJSX}
                    {articleDisplayJSX}
                </div>
