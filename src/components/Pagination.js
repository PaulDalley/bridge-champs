        ...
        return (
            <ul className="pagination">
                ...
                {pager.pages.map((page, index) => {
                    ...
                    if (pager.pages.length > 5 &&
                        (this.state.currentPage !== 1) &&
                        (page > this.state.currentPage+2 ||
                         page < this.state.currentPage-2)) {
                        // console.log("CURRENT PAGE: " + this.state.currentPage);
                        // console.log("IS ACTUALLY: " + index);
                        // console.log("2 pages earlier: " + this.state.currentPage-3);
                        // console.log("2 pages after: " + this.state.currentPage-3);
                        // if (page !== 0) return;
                        return;
                    }
                ...
                {
                    pager.pages.length > 5 && (this.state.currentPage + 2) < pager.pages.length &&
                        <li style={{
                            position: 'relative',
                            top: '.45rem',
                            fontSize: '1.7rem'
