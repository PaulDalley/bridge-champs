...
export const QUICK_TIPS = [
  ...
  { slug: 'lead-trumps-2', title: 'Lead Trumps #1', cat: 'Defence', videoId: 'DsYf-6rHo90', dur: '', blocks: [
  ...
  { slug: 'lead-trumps-vs-sacrifice', title: 'Lead Trumps #2', cat: 'Defence', videoId: 'RJgp-Nk6ICI', dur: '', blocks: [
  ...
  { slug: '7-card-good-suit', title: '7 card GOOD suit', cat: 'Bidding', videoId: 'TKJ3cskhVZI', dur: '', blocks: [
  ...
  { slug: 'open-or-preempt', title: 'To open or not, pre-empt or not', cat: 'Bidding', videoId: '5XVYILI19ig', dur: '', blocks: [
  ...
  { slug: 'misfit-dont-compete', title: "Let the opponents play when they are misfitting", cat: 'Bidding', videoId: 'qUH1oJCHPRY', dur: '', blocks: [
  ...
  { slug: 'the-strongest-hand', title: 'The strongest hand', cat: 'Bidding', videoId: 'kR5sMchpf_0', dur: '', blocks: [
  ...
  { slug: 'be-practical', title: 'Be practical', cat: 'Bidding', videoId: 'iq2IPnA9Qlw', dur: '', blocks: [
